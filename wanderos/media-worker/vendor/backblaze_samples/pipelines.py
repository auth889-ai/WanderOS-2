"""VENDORED from backblaze-labs/genblaze-gen-media-multi-provider-sample (MIT, (c) 2026 Backblaze, Inc.)
Vendored file-for-file as engine reference; adaptations live in app/repo/, not here.
See vendor/backblaze_samples/LICENSE."""
