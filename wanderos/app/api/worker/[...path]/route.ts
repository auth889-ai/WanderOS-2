...
const ALLOWED = new Set([
  ...
  "planning/itinerary/validate", "planning/accessibility", "planning/true-cost", "journey/twin", "journey/cascade", "journey/pulse", "media/rescue-film", "disruption/flight-status", "journey/pulse/protect", "journey/export", "planning/destinations",
